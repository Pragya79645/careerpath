  ...
  try {
    ...
    const parseCompletion = await groq.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a resume parsing assistant. Extract key information from the resume text provided. Format your response as a JSON object.'
        },
        {
          role: 'user',
    ...
    const careerAnalysisCompletion = await groq.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a career counselor AI. Analyze the resume and provide career path recommendations with skill gap analysis.'
        },
        {
          role: 'user',
    ...
    const improvementCompletion = await groq.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a resume improvement expert. Analyze the resume and provide specific suggestions for improvement.'
        },
        {
          role: 'user',
